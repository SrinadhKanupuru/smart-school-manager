...
import 'teacher_added_success_screen.dart';
...
class _AddTeacherFormState extends State<AddTeacherForm> {
    ...
    Navigator.push(
      ...
      if (success == true && mounted) {
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => TeacherAddedSuccessScreen(
              name: _nameCtrl.text.trim(),
              email: _emailCtrl.text.trim(),
              mobile: _phoneCtrl.text.trim(),
              subject: _qualificationCtrl.text.trim(),
            ),
          ),
        );
      }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Add Staff / Teacher')),
      body: SafeArea(
              ...
              children: [
                DropdownButtonFormField<String>(
                  ...
                  items: const [
                    ...
                    DropdownMenuItem(value: 'PT', child: Text('Physical Trainer (PT)')),
                    DropdownMenuItem(value: 'STAFF_HEAD', child: Text('Staff Head')),
                  ],
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(labelText: 'Full Name*', hintText: 'Enter staff/teacher full name'),
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(labelText: 'Email ID*', hintText: 'Enter email address'),
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(labelText: 'Qualification / Specialization*', hintText: 'e.g. M.Sc. Mathematics'),
                  validator: (val) => val == null || val.isEmpty ? 'Enter specialization' : null,
                ),
                const SizedBox(height: 16),
                TextFormField(
                ...
                ElevatedButton(
                  onPressed: _submit,
                  child: const Text('Add Staff / Teacher'),
                ),
              ],
            ),
          ),
